...
set hls_mains_signal_verilog [concat \
  [lsort [glob -directory $hls_mains_signal_hdl *.v]] \
  [list [file join $design_root MeterProcessing tb hls_mains_signal_engine_ip.v]]]
