...
begin
  registers : entity work.meter_processing_axi_regs
    port map (
      ...
      -- Legacy voltage-only wrapper: retain the expanded processing register
      -- contract while leaving the MeterCore-owned frequency producer absent.
      frequency_shadow_control_o => open,
      frequency_shadow_window_samples_o => open,
      frequency_shadow_minimum_millihz_o => open,
      frequency_shadow_maximum_millihz_o => open,
      frequency_shadow_hysteresis_uv_o => open,
      frequency_active_control_i => x"00000A63",
      frequency_active_window_samples_i => x"00007D00",
      frequency_active_minimum_millihz_i => x"00009C40",
      frequency_active_maximum_millihz_i => x"00011170",
      frequency_active_hysteresis_uv_i => x"000F4240",
      frequency_status_i => (others => '0'),
      frequency_millihz_i => (others => '0'),
      ...
      hls_agg_record_count_i => (others => '0'),
      hls_agg_mismatch_count_i => (others => '0'),
      hls_agg_drop_count_i => (others => '0'),
