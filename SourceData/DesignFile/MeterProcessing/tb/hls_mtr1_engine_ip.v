// Non-project binding for the HLS MTR1 engine IP customization.
//
// In the Vivado product project, module hls_mtr1_engine_ip comes from the
// packaged-IP customization (SourceData/IP/hls_mtr1_engine_ip). The
...
module hls_mtr1_engine_ip (
    input           ap_clk,
    input           ap_rst_n,
    input  [1263:0] s_sample_TDATA,
