...
--Date        : Sun Jul 19 23:27:02 2026
--Host        : mnc1 running 64-bit Ubuntu 24.04.4 LTS
--Command     : generate_target MeterProcessing_inst_0_wrapper.bd
--Design      : MeterProcessing_inst_0_wrapper
...
entity MeterProcessing_inst_0_wrapper is
  port (
...
end MeterProcessing_inst_0_wrapper;

architecture STRUCTURE of MeterProcessing_inst_0_wrapper is
  component MeterProcessing_inst_0 is
  port (
    aresetn_0 : in STD_LOGIC;
    aclk_0 : in STD_LOGIC;
    capture_frame_count_i_0 : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component MeterProcessing_inst_0;
begin
MeterProcessing_inst_0_i: component MeterProcessing_inst_0
     port map (
