...
entity StatusSignal_inst_0_wrapper is
  port (
...
end StatusSignal_inst_0_wrapper;

architecture STRUCTURE of StatusSignal_inst_0_wrapper is
  component StatusSignal_inst_0 is
  port (
    RPU_HeatBeat_Signal_tri_o : out STD_LOGIC_VECTOR ( 0 to 0 );
    S_AXI_0_araddr : in STD_LOGIC_VECTOR ( 8 downto 0 );
    S_AXI_0_arready : out STD_LOGIC;
  ...
  end component StatusSignal_inst_0;
begin
StatusSignal_inst_0_i: component StatusSignal_inst_0
     port map (
