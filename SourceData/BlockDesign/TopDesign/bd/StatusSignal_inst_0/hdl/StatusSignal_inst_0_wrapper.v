...
//Date        : Thu Jul 16 13:39:48 2026
//Host        : mnc1 running 64-bit Ubuntu 24.04.4 LTS
//Command     : generate_target StatusSignal_inst_0_wrapper.bd
//Design      : StatusSignal_inst_0_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module StatusSignal_inst_0_wrapper
   (PL_HeatBeat_Signal,
    RPU_HeatBeat_Signal_tri_o,
    S_AXI_0_araddr,
    S_AXI_0_arready,
    S_AXI_0_arvalid,
    S_AXI_0_awaddr,
    ...
    s_axi_aclk_0,
    s_axi_aresetn_0);
  output PL_HeatBeat_Signal;
  output [0:0]RPU_HeatBeat_Signal_tri_o;
  ...
  wire PL_HeatBeat_Signal;
  wire [0:0]RPU_HeatBeat_Signal_tri_o;
  ...
  StatusSignal_inst_0 StatusSignal_inst_0_i
       (.PL_HeatBeat_Signal(PL_HeatBeat_Signal),
        .RPU_HeatBeat_Signal_tri_o(RPU_HeatBeat_Signal_tri_o),
