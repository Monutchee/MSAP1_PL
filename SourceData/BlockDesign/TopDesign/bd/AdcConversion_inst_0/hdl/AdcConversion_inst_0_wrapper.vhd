...
--Command     : generate_target AdcConversion_inst_0_wrapper.bd
--Design      : AdcConversion_inst_0_wrapper
...
entity AdcConversion_inst_0_wrapper is
  port (
...
end AdcConversion_inst_0_wrapper;

architecture STRUCTURE of AdcConversion_inst_0_wrapper is
  component AdcConversion_inst_0 is
  port (
    s_axis_aresetn_0 : in STD_LOGIC;
    s_axis_aclk_0 : in STD_LOGIC;
    s_axis_raw_0_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component AdcConversion_inst_0;
begin
AdcConversion_inst_0_i: component AdcConversion_inst_0
     port map (
